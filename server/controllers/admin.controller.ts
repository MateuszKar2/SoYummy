...
//  */
// export const retrieveLogInfo = async (req: Request, res: Response) => {
//   try {
...
//  */
// export const deleteLogInfo = async (req: Request, res: Response) => {
//   try {
...
//  */
// export const retrieveServicePreference = async (req: Request, res: Response) => {
//   try {
...
//  */
// export const updateServicePreference = async (req: Request, res: Response) => {
//   try {
//     const {
//       usePerspectiveAPI,
